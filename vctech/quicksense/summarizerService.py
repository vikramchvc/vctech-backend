...
class Summarizer():
    ...
    def extract_transcript_and_title(self):
        ...
        if("noTransscript"==transcripts):
            return title,"noTransscript",transcripts
    ...
    def summarise(self):
        title,transcript,transcripts = self.extract_transcript_and_title()
        response={
            "error":"cannotProcess"
        }
        if(transcript=="noTransscript"):
            response = {
                "error":"noTransscript"
            }
        else:
